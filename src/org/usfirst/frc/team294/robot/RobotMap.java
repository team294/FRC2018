...
public class RobotMap {
	...
	public static final int pnuematicArmBrake = 1; // At this point, 2/14/18, we do not envision that a brake is
													// required - All ArmBrake code should be commented out
	...
	} // Enum for preset positions to use in the code (e.g. placing on scale low,
		// switch, pickup, etc.
