...
//	Needs command integration. Should open intake/reset when Robot.inputs.isCubeFullyIn() returns true
	...
	public void setIntakeMotorToPercentPower(double leftPercent, double rightPercent) {
		...
		System.out.println("Left Intake motor " + intakeMotorLeft.getDeviceID() + " set to percent " + leftPercent + ", output "
				+ intakeMotorLeft.getMotorOutputVoltage() + " V," + intakeMotorLeft.getOutputCurrent() + " A, Bus at "
				+ intakeMotorLeft.getBusVoltage() + " V");
